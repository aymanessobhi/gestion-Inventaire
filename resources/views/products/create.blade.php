            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="small font-italic text-muted mb-2">JPG or PNG mois de 2 MB</div>
                        <!-- Product image input -->
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="small mb-1" for="product_name">Nom de produit <span class="text-danger">*</span></label>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('category_id') is-invalid @enderror" id="category_id" name="category_id">
                                    <option selected="" disabled="">Sélectionée Catégorie :</option>
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="unit_id">Unité de produit <span class="text-danger">*</span></label>
                                <select class="form-select form-control-solid @error('unit_id') is-invalid @enderror" id="unit_id" name="unit_id">
                                    <option selected="" disabled="">Sélectionée Unité:</option>
