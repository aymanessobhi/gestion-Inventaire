        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    ...
                    <a href="{{ route('purchases.allPurchases') }}" class="btn btn-danger add-list my-1"><i class="fa-solid fa-trash me-3"></i>Effacer rechercher</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="form-group row align-items-center justify-content-between">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" id="search" class="form-control me-1" name="search" placeholder="rechercher commande" value="{{ request('search') }}">
                        ...
                        <table class="table table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="btn btn-{{ $purchase->purchase_status == 0 ? 'warning' : 'success' }} btn-sm text-uppercase">{{ $purchase->purchase_status == 0 ? 'En attente' : 'Approuvée' }}</span>
                                    </td>
                                    <td>
                                        <div class="d-flex">
