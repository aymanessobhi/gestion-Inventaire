            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3 mb-3">
                        <!-- Groupe de formulaire (total produit) -->
                        <div class="col-md-6">
                            <label class="small mb-1">Total des produits</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <select class="form-select form-control-solid @error('customer_id') is-invalid @enderror" id="customer_id" name="customer_id">
                                    <option selected="" disabled="">Sélectionée client:</option>
                            ...
                            <div class="col-md-12 mt-4">
                                <div class="d-flex flex-wrap align-items-center justify-content-center">
                                    ...
                                    <button type="submit" class="btn btn-success add-list mx-1">Créer une facture</button>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <form action="{{ route('pos.index') }}" method="GET">
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                ...
                                <div class="form-group row align-items-center justify-content-between">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" id="search" class="form-control me-1" name="search" placeholder="rechercher produit" value="{{ request('search') }}">
                            ...
                            <table class="table table-striped align-middle">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">@sortablelink('stock', 'Stock')</th>
