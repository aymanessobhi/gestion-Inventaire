            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="small font-italic text-muted mb-2">JPG ou PNG, ne dépassant pas 1 Mo
                        </div>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('type') is-invalid @enderror" id="type" name="type">
                                    ...
                                    <option value="Distributor" @if(old('type') == 'Distributor')selected="selected"@endif>Distributeur</option>
                                    <option value="Whole Seller" @if(old('type') == 'Whole Seller')selected="selected"@endif>Grossiste</option>
                                </select>
                                @error('type')
                                <div class="invalid-feedback">
                                    {{ $message }}
